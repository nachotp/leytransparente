! function (e, t) {
    ...
    var e = function (e, t, a, i) {
        this.language = e, this.months = t, this.monthsAbbr = a, this.days = i, this.rtl = !1, this.ymd = !1, this.yearSuffix = ""
    },
        t = {
            language: {
                configurable: !0
    ...
    ! function () {
        if ("undefined" != typeof document) {
            ...
            t.type = "text/css", t.styleSheet ? t.styleSheet.cssText = "" : t.appendChild(document.createTextNode("")), e.appendChild(t)
        }
    }();
    var l = {
        render: function () {
    ...
    var r = {
        ...
        computed: {
            ...
            days: function () {
                for (var e = this.pageDate, t = [], a = this.useUtc ? new Date(Date.UTC(e.getUTCFullYear(), e.getUTCMonth(), 1)) : new Date(e.getFullYear(), e.getMonth(), 1, e.getHours(), e.getMinutes()), i = this.utils.daysInMonth(this.utils.getFullYear(a), this.utils.getMonth(a)), s = 0; s < i; s++) t.push({
        ...
        render: function () {
            ...
            return a("div", {
                ...
                return a("span", {
                    ...
                    on: {
                        click: function (a) {
                            a.stopPropagation(), e.selectMonth(t)
                        }
                    }
                }, [e._v(e._s(t.month))])
            })], 2)
        ...
        render: function () {
            ...
            return a("div", {
                ...
                return a("span", {
                    ...
                    on: {
                        click: function (a) {
                            a.stopPropagation(), e.selectYear(t)
                        }
                    }
                }, [e._v(e._s(t.year))])
            })], 2)
        ...
        if ("undefined" != typeof document) {
            ...
            methods: {
                ...
                setInitialView: function () {
                    ...
                    if (!this.allowedToShowView(e)) throw new Error("initialView '" + this.initialView + "' cannot be rendered based on minimum '" + this.minimumView + "' and maximum '" + this.maximumView + "'");
                    switch (e) {
                        case "year":
